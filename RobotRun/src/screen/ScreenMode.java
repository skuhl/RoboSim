...
public enum ScreenMode {
	 ...
	 */
	SET_BOOL_CONST(ScreenType.TYPE_ITEM_EDIT),
	SET_FRAME_INSTR_TYPE(ScreenType.TYPE_ITEM_EDIT),
	SET_IF_STMT_ACT(ScreenType.TYPE_ITEM_EDIT),
	SET_IO_INSTR_STATE(ScreenType.TYPE_ITEM_EDIT),
	SET_MINST_TYPE(ScreenType.TYPE_ITEM_EDIT),
	SET_MINST_REG_TYPE(ScreenType.TYPE_ITEM_EDIT),
	SET_MINST_OBJ(ScreenType.TYPE_ITEM_EDIT),
	SET_MINST_CREG_TYPE(ScreenType.TYPE_ITEM_EDIT),
	SET_MINST_OFF_TYPE(ScreenType.TYPE_ITEM_EDIT),
	SET_REG_EXPR_TYPE(ScreenType.TYPE_ITEM_EDIT),
	SET_SELECT_STMT_ARG(ScreenType.TYPE_ITEM_EDIT),
	SET_SELECT_STMT_ACT(ScreenType.TYPE_ITEM_EDIT),
	SET_BOOL_EXPR_ARG(ScreenType.TYPE_ITEM_EDIT),
	SET_EXPR_ARG(ScreenType.TYPE_ITEM_EDIT),
	SET_EXPR_OP(ScreenType.TYPE_ITEM_EDIT),
	SET_OBJ_OPERAND_TGT(ScreenType.TYPE_ITEM_EDIT),
