...
public class Fixture extends WorldObject {
	...
	public void removeCoordinateSystem() {
		...
		RobotRun.getInstance().applyMatrix(tMatrix[0][0], tMatrix[0][0], tMatrix[0][2], tMatrix[0][3],
										   tMatrix[1][0], tMatrix[1][0], tMatrix[1][2], tMatrix[1][3],
										   tMatrix[2][0], tMatrix[2][0], tMatrix[2][2], tMatrix[2][3],
										   0,             0,             0,             1);
	}
}